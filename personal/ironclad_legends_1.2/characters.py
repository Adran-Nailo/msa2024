class Characters():
    def __init__(self,coordinates_x,coordinates_y,score,icon,current_map,health,damage,sword_count,potion_count,wall_count,render_distance,basic_attack_unlocked,advanced_attack_unlocked,armor,basic_shield,advanced_shield,block,save_file):
